...
public class ModBlock {
    ...
    public static final Block STONE_SPEEDS_ORE = registerBlock("stone_speeds_ore",
            new ExperienceDroppingBlock(UniformIntProvider.create(2, 5),
                    AbstractBlock.Settings.create().strength(3f).requiresTool()));
    public static final Block STONE_SPEEDS_DEEPSLATE_ORE = registerBlock("stone_speeds_deepslate_ore",
